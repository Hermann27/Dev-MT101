...
Imports System.Text
Public Class FournisseurDouaneVirement
    ...
    Private Sub EditionAttestation_Manuelle(ByRef P_ReferenceInterne As String, ByRef P_NomFinance As String, ByRef P_PosteSignataire As String, ByRef P_OriginalCopie As Integer, ByRef P_DoualaLe As Date, ByRef P_CaptionFournisseur As String, ByRef P_AdresseFournisseur As String, ByRef P_Banque_Fournisseur As String, ByRef MontantNet As Double)
        ...
        Try
            ...
            If CpteDatatable.Rows.Count <> 0 Then
                ...
                AttestationDroitdeDouane.SetDataSource(CpteDataset)
                For Each tbCurrent In AttestationDroitdeDouane.Database.Tables
                    ...
                    AttestationDroitdeDouane.Database.Tables(0).ApplyLogOnInfo(tliCurrent)
                Next tbCurrent
                If Trim(Num_Cheque) <> "" Then
                    AttestationDroitdeDouane.SetParameterValue("Objet_Reglement", Num_Cheque)
                Else
                    AttestationDroitdeDouane.SetParameterValue("Objet_Reglement", "")
                End If
                If P_OriginalCopie = 1 Then
                    AttestationDroitdeDouane.SetParameterValue("P_ReferenceInterne", P_ReferenceInterne)
                    AttestationDroitdeDouane.SetParameterValue("P_OriginalCopie", "ORIGINAL")
                Else
                    AttestationDroitdeDouane.SetParameterValue("P_OriginalCopie", "COPIE")
                    AttestationDroitdeDouane.SetParameterValue("P_ReferenceInterne", P_ReferenceInterne)
                End If
                If Trim(P_NomFinance) <> "" Then
                    AttestationDroitdeDouane.SetParameterValue("P_NomFinance", P_NomFinance)
                Else
                    AttestationDroitdeDouane.SetParameterValue("P_NomFinance", "")
                End If
                If Trim(P_PosteSignataire) <> "" Then
                    AttestationDroitdeDouane.SetParameterValue("P_PosteSignataire", P_PosteSignataire)
                Else
                    AttestationDroitdeDouane.SetParameterValue("P_PosteSignataire", "")
                End If
                AttestationDroitdeDouane.SetParameterValue("P_DoualaLe", Format(P_DoualaLe, "dd MMM yyyy"))
                AttestationDroitdeDouane.SetParameterValue("P_CaptionFournisseur", P_CaptionFournisseur)
                AttestationDroitdeDouane.SetParameterValue("MontantNet", Format(MontantNet, "##,##0") & " FCFA")
                ...
                If Convert.IsDBNull(vSiteAdressetiers) = False Then
                    ...
                    If Convert.IsDBNull(vSiteAdressetiers) = False Then
                        If Trim(vSiteAdressetiers.codePostal) <> "" Then
                            AttestationDroitdeDouane.SetParameterValue("P_CodePostalFournisseur", vSiteAdressetiers.codePostal)
                        Else
                            AttestationDroitdeDouane.SetParameterValue("P_CodePostalFournisseur", "")
                        End If
                        If Trim(vSiteAdressetiers.ville) <> "" Then
                            AttestationDroitdeDouane.SetParameterValue("P_Ville_Fournisseur", vSiteAdressetiers.ville)
                        Else
                            AttestationDroitdeDouane.SetParameterValue("P_Ville_Fournisseur", "")
                        End If
                    Else
                        AttestationDroitdeDouane.SetParameterValue("P_Ville_Fournisseur", "")
                        AttestationDroitdeDouane.SetParameterValue("P_CodePostalFournisseur", "")
                ...
                If Convert.IsDBNull(vComptebancairetiers) = False Then
                    If Trim(vComptebancairetiers.Caption) <> "" Then
                        AttestationDroitdeDouane.SetParameterValue("P_Banque_Fournisseur", vComptebancairetiers.Caption)
                    Else
                        AttestationDroitdeDouane.SetParameterValue("P_Banque_Fournisseur", "")
                    End If
                    If Trim(vComptebancairetiers.numeroCompte) <> "" Then
                        AttestationDroitdeDouane.SetParameterValue("P_CompteBancaire_Fournisseur", Trim(vComptebancairetiers.numeroCompte))
                    Else
                        AttestationDroitdeDouane.SetParameterValue("P_CompteBancaire_Fournisseur", Trim(vComptebancairetiers.numeroCompte))
                    End If
                Else
                    AttestationDroitdeDouane.SetParameterValue("P_CompteBancaire_Fournisseur", "")
                    AttestationDroitdeDouane.SetParameterValue("P_Banque_Fournisseur", "")
                End If
                CrvEdition.ReportSource = AttestationDroitdeDouane
                CrvEdition.ShowLastPage()
                AttestationDroitdeDouane.PrintOptions.PrinterName = NomImprimante
                AttestationDroitdeDouane.PrintToPrinter(1, False, 1, CrvEdition.GetCurrentPageNumber)
    ...
    Private Sub EditionAttestation_eBanking(ByRef P_ReferenceInterne As String, ByRef P_NomFinance As String, ByRef P_PosteSignataire As String, ByRef P_OriginalCopie As Integer, ByRef P_DoualaLe As Date, ByRef P_CaptionFournisseur As String, ByRef P_Banque_Fournisseur As String, ByRef P_AdresseFournisseur As String, ByRef MontantNet As Double)
        ...
        Try
            ...
            If CpteDatatable.Rows.Count <> 0 Then
                ...
                For Each tbCurrent In AttestationDroitdeDouane.Database.Tables
                    ...
                    AttestationDroitdeDouane.Database.Tables(0).ApplyLogOnInfo(tliCurrent)
                Next tbCurrent
                AttestationDroitdeDouane.SetParameterValue("Objet_Reglement", "Règlement droits de douane // Attestation de Retenue à la Source")
                If P_OriginalCopie = 1 Then
                    AttestationDroitdeDouane.SetParameterValue("P_ReferenceInterne", P_ReferenceInterne)
                    AttestationDroitdeDouane.SetParameterValue("P_OriginalCopie", "ORIGINAL")
                Else
        ...
        End Try
    End Sub
    Private Sub EditionOrdreVirement_Manuelle(ByRef P_ReferenceInterne As String, ByRef P_BanqueEtablissement As String, ByRef P_Intitule As String, ByRef P_OriginalCopie As Integer, ByRef P_DoualaLe As Date, ByRef P_CaptionFournisseur As String, ByRef P_Banque_Fournisseur As String, ByRef MontantNet As Double)
        ...
        Try
            ...
            If CpteDatatable.Rows.Count <> 0 Then
                ...
                If Convert.IsDBNull(vComptebancaireEtablissement) = False Then
                    ...
                    If Convert.IsDBNull(vEtablissement) = False Then
                        If Trim(vEtablissement.Caption) <> "" Then
                            OrdrevirementDroitdedouane.SetParameterValue("P_BanqueAES", vEtablissement.Caption)
                        Else
                            OrdrevirementDroitdedouane.SetParameterValue("P_BanqueAES", "")
                        End If
                    Else
                        OrdrevirementDroitdedouane.SetParameterValue("P_BanqueAES", "")
                    End If
                Else
                    OrdrevirementDroitdedouane.SetParameterValue("P_BanqueAES", "")
                    OrdrevirementDroitdedouane.SetParameterValue("P_CompteBancaireAES", "")
                End If
                If Trim(P_Intitule) <> "" Then
                    OrdrevirementDroitdedouane.SetParameterValue("P_Intitule", P_Intitule)
                Else
                    OrdrevirementDroitdedouane.SetParameterValue("P_Intitule", "")
                End If
                If P_OriginalCopie = 1 Then
                    OrdrevirementDroitdedouane.SetParameterValue("P_ReferenceInterne", P_ReferenceInterne)
                    OrdrevirementDroitdedouane.SetParameterValue("P_OriginalCopie", "ORIGINAL")
                Else
                    OrdrevirementDroitdedouane.SetParameterValue("P_OriginalCopie", "COPIE")
                    OrdrevirementDroitdedouane.SetParameterValue("P_ReferenceInterne", P_ReferenceInterne)
                End If
                OrdrevirementDroitdedouane.SetParameterValue("P_Montant", Format(MontantNet, "##,##0") & " FCFA")
                OrdrevirementDroitdedouane.SetParameterValue("P_MontantLettre", Convert_Sommes_Lettre(Renvoi_Partie_Ent(CDbl(Math.Abs(Math.Round(MontantNet, 0))))))
                OrdrevirementDroitdedouane.SetParameterValue("P_DoualaLe", P_DoualaLe)
                OrdrevirementDroitdedouane.SetParameterValue("P_CaptionFournisseur", P_CaptionFournisseur)
                arg_Num(0) = Trim(P_Banque_Fournisseur)
                vComptebancairetiers = ClasMan.FindObject("TCompteBancaire", "(oid=%1)", "oid", True, arg_Num)
                If Convert.IsDBNull(vComptebancairetiers) = False Then
                    If Trim(vComptebancairetiers.Caption) <> "" Then
                ...
                Else
                    ...
                    OrdrevirementLocal.SetParameterValue("P_AgenceBancaireFournisseur", "")
                End If
                CrvEdition.ReportSource = OrdrevirementDroitdedouane
                CrvEdition.ShowLastPage()
                OrdrevirementDroitdedouane.PrintOptions.PrinterName = NomImprimante
                OrdrevirementDroitdedouane.PrintToPrinter(1, False, 1, CrvEdition.GetCurrentPageNumber)
    ...
    Private Sub Btcheque_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btcheque.Click
        InfosupDouaneVirement.ShowDialog()
    End Sub
    ...
    Private Sub BtEditer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtEditer.Click
        ...
        Try
            ...
            If Trim(Numvirement.Text) <> "" And Trim(NumLettre.Text) <> "" Then
                If IsNumeric(Trim(Numvirement.Text)) = True And IsNumeric(Trim(NumLettre.Text)) = True Then
                                                                                                                ...
                                                                                                                If OidModeReglement.MRCitibank = "EFT" Then 'virement étranger                                                                                                           
                                                                                                                    ...
                                                                                                                    If vListEditionReglement.Count <> 0 Then
                                                                                                                        ...
                                                                                                                        If EstParametre = True Then
                                                                                                                            For m As Integer = 1 To CInt(Trim(NumLettre.Text))
                                                ...
                                                For j As Integer = 0 To OledtFournisseur.Rows.Count - 1
                                                    ...
                                                    If Trim(OledtFournisseur.Rows(j).Item("OidBordereauReglement").ToString) <> "" And Trim(OledtFournisseur.Rows(j).Item("OidRoleTiers").ToString) <> "" Then
                                                        ...
                                                        If Convert.IsDBNull(ReferenceFactureInterne) = False Then
                                                            ...
                                                            Next m
                                                            For m As Integer = 1 To CInt(Trim(Numvirement.Text))
                                                                EditionOrdreVirement_Manuelle(ReferenceInterne, OledtFournisseur.Rows(j).Item("OidcompteBancaireEts").ToString, Txt_Aes.Text, m, Format(DTdate.Value, "dd MMM yyyy"), Trim(OledtFournisseur.Rows(j).Item("Caption").ToString), OledtFournisseur.Rows(j).Item("OidcompteBancaireTiers").ToString, Format((SomMnt - (SomIs + SomTva)), "##,##0"))
                                                            Next m
                                                            If EstEditer = True Then
                                                                ClasMan.BeginTran(True)
                    ...
                    End If
                Else
                    MsgBox("Le nombre de Facture ou d'ordre de virement doit être une valeur numérique", vbInformation, "Edition de Règlement")
                End If
            Else
                If Directory.Exists(Pathsfilejournal) = True Then
                    FichierExtrait = Pathsfilejournal & "BordereauReglement" & Strings.Right(DateAndTime.Year(Now), 4) & "" & Format(DateAndTime.Month(Now), "00") & "" & Format(DateAndTime.Day(Now), "00") & "_" & "" & Format(DateAndTime.Hour(Now), "00") & "_" & Format(DateAndTime.Minute(Now), "00") & "_" & Format(DateAndTime.Second(Now), "00") & ".txt"
    ...
    Private Sub BtAfficher_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtAfficher.Click
        ...
        '    Else
        '        MsgBox("Echec de connexion à la société/application " & Chr(13) & "" & Chr(13) & "    Modifiez Le Fichier de Configuration", MsgBoxStyle.YesNo, "Connexion à la société/application")
        '    End If
        'Else
        '    MsgBox("Echec de connexion à la base Master " & Chr(13) & "" & Chr(13) & "    Modifiez Le Fichier de Configuration", MsgBoxStyle.YesNo, "Connexion à la base Master")
        'End If
