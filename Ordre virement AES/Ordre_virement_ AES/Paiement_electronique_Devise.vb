...
Public Class Paiement_electronique_Devise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Paiement_electronique_Devise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordre_virement_AES.Paiement_electronique_Devise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_P_CompteBancaire_Etablissement() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_P_Banque_Etablissement() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_P_Bordereau() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPaiement_electronique_Devise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Paiement_electronique_Devise = New Paiement_electronique_Devise
        rpt.Site = Me.Site
        Return rpt
    End Function
